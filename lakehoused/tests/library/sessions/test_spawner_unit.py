...
from lakehoused.sessions.spawner import AgentNotFoundError
from lakehoused.sessions.spawner import SessionNotFoundError
from lakehoused.sessions.spawner import resume_spawned_agent
from lakehoused.sessions.spawner import spawn_agent
...
class TestSpawnAgentSessionCreation:
    ...
    async def test_creates_child_session_with_merged_config(self):
        ...
        with patch("amplifier_core.AmplifierSession") as mock_session_class:
