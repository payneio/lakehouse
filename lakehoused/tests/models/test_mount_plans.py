...
class TestReferencedMount:
    ...
    def test_valid_creation_provider(self) -> None:
        ...
        mount = ReferencedMount(
            ...
            source_path="file:///home/user/.lakehoused/share/profiles/foundation/base/providers/anthropic.py",
    ...
    def test_valid_creation_tool(self) -> None:
        ...
        mount = ReferencedMount(
            ...
            module_type="tool",
            source_path="file:///home/user/.lakehoused/share/profiles/foundation/base/tools/file_reader.py",
        )
    ...
    def test_valid_creation_hook(self) -> None:
        ...
        mount = ReferencedMount(
            ...
            module_type="hook",
            source_path="file:///home/user/.lakehoused/share/profiles/foundation/base/hooks/pre_commit.py",
        )
