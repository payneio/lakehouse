...
All module references must include the `source` field specifying where to load the module from.

**Source URI format:**

- File: `file:///absolute/path`

**Resolution:** If `source` is provided, the ModuleSourceResolver resolves it.
