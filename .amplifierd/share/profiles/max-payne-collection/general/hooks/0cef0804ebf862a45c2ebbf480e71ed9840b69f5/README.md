# Amplifier Backup Hook Module

Transcript backup and preservation hook for Amplifier sessions.
...
- Saves transcripts after each turn
...
- Automatic backup on session events
