...
from amplifierd.models.bundles import BundleDetails
from amplifierd.models.bundles import BundleListItem
from amplifierd.models.bundles import BundleSource
from amplifierd.models.bundles import CopyBundleRequest
from amplifierd.models.bundles import CreateBundleRequest
from amplifierd.models.bundles import ResolvedBundle
from amplifierd.models.bundles import UpdateBundleRequest
...
async def list_bundles() -> list[BundleListItem]:
    ...
    Bundles are loaded from ~/.amplifierd/bundles/ (user) and
    ~/.amplifierd/share/bundles/ (system).
